...
export const MOCK_EXCEPTION_SUMMARY = {
  achDebitDecisioning: { total: 12 },
  payoutRetryQueue:    { total: 8 },
  vanExceptions:       { total: 4 },
  reconExceptions:     { total: 7 },
  achProcessingErrors: { total: 3 },
  achReturns:          { total: 5 },
  rtpFedNowExceptions: { total: 2 },
  payoutExceptions:    { total: 3 },
  infraAlerts:         { total: 1 },
};

export const EXCEPTION_CATEGORY_LABELS = {
  achDebitDecisioning: 'ACH Debit Decisioning',
  payoutRetryQueue:    'Payout / Funding Retry',
...
export const MOCK_ACH_DEBIT_QUEUE = [
  // CRITICAL: Insufficient funds, deadline imminent
  {
    ...
    shopId: 'SHOP-8832',
    partnerId: 'PTR-100',
    shopLegalName: 'Johnson Enterprises LLC',
    taxId: '**-***4521',
    shopDBA: "Mike's Auto Parts",
    nbsLimit: 5000.00,
    totalNegativeBalance: -1200.00,
  ...
  },
  {
    ...
    shopId: 'SHOP-9902',
    partnerId: 'PTR-205',
    shopLegalName: 'Garcia Import Export Inc',
    taxId: '**-***8844',
    shopDBA: 'Garcia Imports',
    nbsLimit: null,
    totalNegativeBalance: null,
    status: 'PENDING_DECISION',
    assignedTo: null,
    notes: [],
    decisionHistory: [],
  ...
  },
  {
    ...
    shopId: 'SHOP-3341',
    partnerId: 'PTR-310',
    shopLegalName: 'Martinez Consulting Group',
    taxId: '**-***3341',
    shopDBA: 'MCG Solutions',
    nbsLimit: 10000.00,
    totalNegativeBalance: null,
    status: 'PENDING_DECISION',
    assignedTo: null,
  ...
  },
  {
    ...
    shopId: 'SHOP-7714',
    partnerId: 'PTR-100',
    shopLegalName: 'Chen Family Holdings LLC',
    taxId: '**-***9102',
    shopDBA: 'Golden Dragon Restaurant',
    nbsLimit: 2000.00,
    totalNegativeBalance: -890.00,
    status: 'PENDING_DECISION',
    assignedTo: null,
    notes: [],
    decisionHistory: [],
  },
  {
    ...
    shopId: 'SHOP-5518',
    partnerId: 'PTR-420',
    shopLegalName: 'Patel Properties Inc',
    taxId: '**-***6733',
    shopDBA: 'Sunrise Realty',
    nbsLimit: 8000.00,
    totalNegativeBalance: -3200.00,
    status: 'PENDING_DECISION',
    assignedTo: null,
    notes: [],
    decisionHistory: [],
  },
  {
    ...
    shopId: 'SHOP-6650',
    partnerId: 'PTR-205',
    shopLegalName: 'Thompson Digital Media LLC',
    taxId: '**-***6650',
    shopDBA: 'TDM Creative',
    nbsLimit: null,
    totalNegativeBalance: null,
    status: 'PENDING_DECISION',
    assignedTo: null,
  ...
  },
  {
    ...
    shopId: 'SHOP-2209',
    partnerId: 'PTR-510',
    shopLegalName: 'Williams & Associates CPA',
    taxId: '**-***2209',
    shopDBA: 'Williams Tax Prep',
    nbsLimit: null,
    totalNegativeBalance: null,
    status: 'PENDING_DECISION',
    assignedTo: null,
  ...
  },
  {
    ...
    shopId: 'SHOP-1145',
    partnerId: 'PTR-510',
    shopLegalName: 'Kim Beauty Supply Corp',
    taxId: '**-***3210',
    shopDBA: 'K-Beauty Wholesale',
    nbsLimit: 15000.00,
    totalNegativeBalance: null,
    status: 'PENDING_DECISION',
    assignedTo: null,
