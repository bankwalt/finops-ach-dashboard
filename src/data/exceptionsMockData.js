...
export const MOCK_ACH_DEBIT_QUEUE = [
  // CRITICAL: Insufficient funds, deadline imminent
  {
    ...
    finxactAccountId: 'ACCT-FX-8832',
    receivingName: 'JOHNSON, MICHAEL',
  ...
  // CRITICAL: Large debit, no offset accounts
  {
    ...
    finxactAccountId: 'ACCT-FX-9902',
    receivingName: 'GARCIA, ROBERTO',
  ...
  // HIGH: Corporate debit, possible unauthorized
  {
    ...
    secCode: 'CCD',
    companyEntryDescription: 'PAYROLL ADJ',
    amount: 5234.10,
    transactionCode: 27,
    routingNumber: '****4521',
    accountNumber: '****3341',
    ...
    finxactAccountId: 'ACCT-FX-3341',
    receivingName: 'MARTINEZ, SARAH',
  ...
  // HIGH: Savings debit, balance tight
  {
    ...
    finxactAccountId: 'ACCT-FX-7714',
    receivingName: 'CHEN, DAVID',
  ...
  // HIGH: Large utility debit, multiple offsets
  {
    ...
    finxactAccountId: 'ACCT-FX-5518',
    receivingName: 'PATEL, RAJESH',
  ...
  // HIGH: WEB entry, account flagged
  {
    ...
    finxactAccountId: 'ACCT-FX-6650',
    receivingName: 'THOMPSON, LISA',
  ...
  // LOW: Sufficient balance, standard check
  {
    ...
    secCode: 'CCD',
    companyEntryDescription: 'TAX PMT',
    amount: 4800.00,
    transactionCode: 27,
    routingNumber: '****4521',
    accountNumber: '****2209',
    ...
    finxactAccountId: 'ACCT-FX-2209',
    receivingName: 'WILLIAMS, ANGELA',
  ...
  // LOW: Small debit, sufficient balance
  {
    ...
    finxactAccountId: 'ACCT-FX-1145',
    receivingName: 'KIM, JENNIFER',
